...
script.src = 'https://api.instagram.com/v1/media/popular?access_token=1075466.1677ed0.07e7f544d7dd41c1a7abb2295cd35a9a&callback=jsonCallback';
document.getElementsByTagName('head')[0].appendChild(script);

function jsonCallback(data){
         displayPhotos(data);
         lightboxTrigger(data);
         window.arr = data;
}
